...
import ru.geekbrains.myJava_spring_lesson5.repositories.CustomerRepository;
import ru.geekbrains.myJava_spring_lesson5.repositories.OrderRepository;
import ru.geekbrains.myJava_spring_lesson5.repositories.ProductRepository;
...
public class SampleData {
    ...
    public void init() {
        ...
        Customer customer4 = new Customer("Barbara");
        ...
        order5.setCurrentPrice(product1.getPrice());
        order5.setCustomer(customer1);
        order5.setProduct(product1);
        order5.setCode("0005");

        Order order6 = new Order();
        order6.setCurrentPrice(product2.getPrice());
        order6.setCustomer(customer2);
        order6.setProduct(product2);
        order6.setCode("0006");

        Order order7 = new Order();
        order7.setCurrentPrice(product3.getPrice());
        order7.setCustomer(customer3);
        order7.setProduct(product3);
        order7.setCode("0007");

        Order order8 = new Order();
        order8.setCurrentPrice(product4.getPrice());
        order8.setCustomer(customer4);
        order8.setProduct(product4);
        order8.setCode("0008");
